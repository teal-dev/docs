...
<CardGroup cols={2}>
  <Card title="Submitting transactions" icon="square-1" href="/accounting_package/platform_gl/transactions/submitting_transactions/create_ledger">
    Send transactions directly to Teal via our API.
  </Card>
  <Card title="Data integrations" icon="square-2" href="/accounting_package/platform_gl/transactions/data_integrations">
