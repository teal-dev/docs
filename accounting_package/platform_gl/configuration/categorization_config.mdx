...
Categorizing transactions is the process of assigning accounting ledgers to real-world transactions.  It is a core accounting processs, and ensures that a user's accounting entries accurately reflect their business.  
...
<Steps>
    ...
    <Step title="Similar transactions">
        ...
        Over time, as more transactions are categorized within an instance, this categorizor becomes more effective. 
    </Step>
