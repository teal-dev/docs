...
When a transaction is created, it is sent to the categorization pipeline where categorizers apply different rules to a transaction and try to match the it to a user’s ledgers.
...
<Steps>
    ...
    <Step title="Platform categorization rules">
        ...
        See [Crafting platform rules](#crafting-platform-rules) below to learn how to write categorization rules in the [developer portal](developer.teal.dev).
    </Step>
