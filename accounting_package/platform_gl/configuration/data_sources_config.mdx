...
Utilizing Teal's Plaid integration enables a seamless workflow for connecting external financial accounts to Teal. We have an official processor-token [partnership](https://plaid.com/docs/auth/partnerships/teal/) with Plaid so that your users easily connect their external financial 
accounts directly to Teal's back end, through your own Plaid account and UX.
