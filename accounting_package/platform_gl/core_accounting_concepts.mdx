...
Our API is designed to allow you to [submit transactions](/transactions/submitting) in more or less 
...
A [chart of accounts](/configuration/chart_of_accounts_config) is the complete set of ledgers that belong to a business. A company's 
