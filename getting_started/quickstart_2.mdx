---
title: "Quick start: Auto-Categorization @Ian review"
...
When you are satisfied with the results of the auto-categorizer, you can click **Recategorize** to push these changes the the chart of accounts. 
You can now view a cashflow report with the updated categories. 
