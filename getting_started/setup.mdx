...
Once we have provisioned your Platform, you will be able to access our [Developer Portal](https://developer.teal.dev/). The first time you visit the portal you will need to create an account
...
Once you are in the [Developer Portal](https://developer.teal.dev/), you can create API tokens to access the API. Calls to our API are authenticated using a bearer token and are sent to our API using an `Authentication: Bearer <token>` HTTP header.
