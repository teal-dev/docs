...
Often, the most valuable implementation is a combination of these offerings. For example, a neobank might offer a simple cash flow analysis tool for free, with an upgrade path to a full-featured accounting suite that removes their customers' need for Quickbooks, which can be further upgraded with a built-in live bookkeeper and tax filer.

Teal offers native integrations with external data sources such as Plaid, Unit, and Stripe, with more coming soon. It 
also supports integrations with your own data sources for data such as banking transactions and balances, payroll data, payments data, and more.
...
We have a live demo available of multiple Teal apps implemented in a fictional neobanking platform. Feel free to [contact us for a live walkthrough](https://teal.dev/contact).
