...
Often, the most valuable implementation is a combination of these offerings. For example, a neobank might offer a simple cashflow analysis tool for free, with an upgrade path to a full-featured accounting suite that removes their customers' need for Quickbooks, which can be further upgraded with a built-in live bookkeeper and tax filer.
