...
A platform is Teal's representation of your business, with it's own configuration, data, and users. All of Teal's APIs operate within the scope of a platform.
