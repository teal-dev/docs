...
financial account should have its own individual ledger. You can find the complete list of supported 
financial account types [here](/ledgers/create_ledger).
...
When you first create a user in Teal, you need to specify the user's [start date](/users/create_user) (`entries_start`). No 
